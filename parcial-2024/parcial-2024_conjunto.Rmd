...
Es evidente cual es la grafica de caja y brazos que pertenece a la muestra original, entonces podemos decir que rechazamos la hipotesis nula de que ambas distribuciones (cancer de mama y de estomago) provienen de la misma distribucion
...
observamos nuestro valor p de una y dos colas (el que nos interesa es el de dos colas)
```{r setup, include=TRUE, message=FALSE}
...
Podemos ver en las graficas que los tratamientos de prueba y de referencia (donde estan disponibles) son similares y tienen practicamente el mismo comportamiento tanto en el mismo individuo como entre ellos. 
